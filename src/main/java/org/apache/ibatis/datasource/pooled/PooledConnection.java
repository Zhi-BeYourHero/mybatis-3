...
class PooledConnection implements InvocationHandler {
  ...
  public PooledConnection(Connection connection, PooledDataSource dataSource) {
    ...
    // 基于 JDK Proxy 创建 Connection 对象，并且 handler 对象就是 this ，
    // 也就是自己。那意味着什么？后续对 proxyConnection 的所有方法调用，
    // 都会委托给 PooledConnection#invoke(Object proxy, Method method, Object[] args) 方法。
   ...
   * 返回代理的 Connection 对象，这样每次对数据库的操作， 才能被 PooledConnection 的 {@link #invoke} 方法拦截
   * @return The proxy
   */
